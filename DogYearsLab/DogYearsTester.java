...
import static kchandra423.kTesting.KAssertion.kAssertMethodExists;

public class DogYearsTester {
    public static void convertToHumanExists() {
        kAssertMethodExists("convertToHumanYears", DogYears.class, int.class);
    }

    public static void convertToDogExists() {
        kAssertMethodExists("convertToDogYears", DogYears.class, int.class);
    }
